...
post_get_params:
xtalk->r_gnd_res_tot_mohms =
			get_r_gnd_res_tot_mohms(xtalk->r_gnd_int_fet_mohms,
						 xtalk->r_gnd_par_route1_mohms,
						 xtalk->r_gnd_par_route2_mohms,
						 xtalk->r_gnd_ext_fet_mohms,
						 xtalk->r_conn_par_load_neg_mohms);
xtalk->r_aud_res_tot_l_mohms =
			get_r_aud_res_tot_mohms(xtalk->r_aud_int_fet_l_mohms,
					   xtalk->r_aud_ext_fet_l_mohms,
					   xtalk->r_conn_par_load_pos_l_mohms);
xtalk->r_aud_res_tot_r_mohms =
			get_r_aud_res_tot_mohms(xtalk->r_aud_int_fet_r_mohms,
